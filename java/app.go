...
func (a *AndroidApp) addDataBindingDeps(ctx android.BottomUpMutatorContext) {
	if a.appProperties.Data_binding.View_binding {
		a.properties.Static_libs.AppendSimpleValue([]string{"androidx.databinding_viewbinding"})
	}
	...
	if a.appProperties.Data_binding.Data_binding {
		...
		a.properties.Static_libs.AppendSimpleValue([]string{"androidx.databinding_databinding-adapters"})
	}
}
...
func (a *AndroidApp) genDataBindingSources(ctx android.ModuleContext) {
	...
	a.aaptProperties.Resource_dirs = proptools.NewConfigurable[[]string](nil, nil)
